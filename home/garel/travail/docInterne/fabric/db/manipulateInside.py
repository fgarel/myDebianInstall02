...
class ManipulateInside():
    ...
    ManipulateInside regroupe les méthodes qui permettent de manipuler
    les données en langage Python (pas de shell ni de fabric)

    ManipulateOutside regoupe les méthode qui permettent de manipuler
