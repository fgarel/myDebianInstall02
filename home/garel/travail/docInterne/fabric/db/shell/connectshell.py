...
class ConnectShell():
    """ Connect est une classe offrant les outils nécessaires pour établir
    une connexion à une base de données postgresql
    """
    def __init__(self):
    ...
    def connect_dbapi(self):
        """
        Connects to the database using a DBAPI-2.0 compliant connection and
        returns a (module, connection) pair.
        """
        try:
